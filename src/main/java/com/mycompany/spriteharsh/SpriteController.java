...
import com.mycompany.spriteharsh.util.JsfUtil;
import com.mycompany.spriteharsh.util.PaginationHelper;
...
public class SpriteController implements Serializable {
    ...
    @EJB
    private com.mycompany.spriteharsh.SpriteFacade ejbFacade;
